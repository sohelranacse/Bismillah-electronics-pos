<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><a href="#" onclick = "location.replace(document.referrer);" class="btn btn-default btn-sm"><i class="icofont icofont-undo"></i></a> COUSTOMER REPORTS</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="date_search">            
            <form action="" method="POST" class="form-horizontal" role="form">                           
                    ...
                    <div class="form-group" style="margin: 0;overflow: hidden;">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-default" onclick="return customer_reports_search()"><i class="icofont icofont-search"></i></button>
                        </div>
                    </div>
            </form>
        </div>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody id="customer_reports_search">
                        <?php
                        if (is_array($results)){ 
                        foreach ($results as $cous_data) {
                            ...
                            $added_date = date_format($create_date, 'd F, Y');
                        ?>
                            <tr>
                                <td>#<?php echo $id; ?></td>
                                <td><?php echo $name; ?></td>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>home/customer_products/<?php echo $id ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont icofont-plus"></i> Sales</a>
                                </td>
                            </tr>
                        <?php }} ?>
                        </tbody>
