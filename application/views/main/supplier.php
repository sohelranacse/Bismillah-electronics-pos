<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><a href="#" onclick = "location.replace(document.referrer);" class="btn btn-default btn-sm"><i class="icofont icofont-undo"></i></a> SUPPLIER</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="form-group" style="overflow: hidden;margin: 0">
                    <div class="col-sm-offset-4 col-sm-4">
                        <div class="form-group input-group">
                            ...
                            <input type="text" onkeyup="return search_name_supp(this)" class="form-control" placeholder="Type Customer Name">
                        </div>
                    </div>
                ...
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#ALL_COUSTOMER" aria-controls="home" role="tab" data-toggle="tab">SUPPLIER</a>
                        </li>
                        <li role="presentation">
                            <a href="#NEW_COUSTOMER" aria-controls="tab" role="tab" data-toggle="tab">NEW SUPPLIER</a>
                        </li>
                    </ul>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><strong><?php echo $loan; ?></strong> Tk.</td>
                                            <td><?php echo $a_date; ?></td>
                                            <td>
                                                <a href="<?php echo base_url(); ?>home/details_supplier/<?php echo $id ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont icofont-user"></i></a>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal_lg" value="<?php echo $id; ?>" onclick="return update_supplier(this)"><i class="icofont icofont-ui-edit"></i></button>
                                            </td>
                                        </tr>
                                    <?php }} ?>
                                    </tbody>
                            ...
                            <div class="coustomer_panel" style="background: #eee">
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Type Supplier Name">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="">Previous Loan</label> <span class="label label-success">Tk.</span>
                                        <input type="text" class="form-control" id="prev_loan" placeholder="Type Previous Due">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 text-center">
                                    <button type="submit" onclick="supp_add()" class="btn btn-info">SUBMIT</button>
                                </div>
                            </div>
