<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><a href="#" onclick = "location.replace(document.referrer);" class="btn btn-default btn-sm"><i class="icofont icofont-undo"></i></a> NEW SALE</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>  
                                    <input type="hidden" id="roots" value="1">
                                ...
                                <td>
                                    <input type="text" id="sell_cous" class="form-control" onkeyup="sell_cous_search()" placeholder="Type Coustomer Name" autofocus="1"  autocomplete="off">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr id="secondStep">
                                <td>
                                    <input type="text" id="sale_product" class="form-control" onkeyup="product_search()" placeholder="Type Product Name" autofocus>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="qty" class="form-control" placeholder="Type Quantity" onblur="check_product_qty()">
                                </td>
                                <td>
                ...
                <div class="col-md-offset-6 col-lg-offset-6 col-md-6 col-lg-6 col-sm-6">
                    <div class="table-responsive">
                        <table class="table" style="border: 1px solid #ddd">
                            ...
                            <tr>
                                <td class="text-center" colspan="2"><button type="button" onclick="product_sale_final()" class="btn btn-info">SUBMIT</button></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
